...
echo 'tracing' > $output_folder/dummy.txt
echo $output_folder
count=0
...
do
    ...
    do
        ...
        --min_replay_capacity_fraction 0.05 --num_iterations 200 --target_network_update_period 40_000 --num_train_frames 25_000 --num_eval_frames 5_000 \
        --option_prob ${option_prob} --num_options 10  \
